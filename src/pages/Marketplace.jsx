...
const s = {
  ...
  hero: { background: '#173404', padding: '2rem 1.5rem 1.75rem' },
  heroTag: { fontSize: 10, fontWeight: 500, letterSpacing: 1, color: '#97C459', textTransform: 'uppercase', marginBottom: 8 },
  heroH:   { fontSize: 24, fontWeight: 500, color: '#f2f7eb', lineHeight: 1.25, marginBottom: 8, letterSpacing: -0.3 },
  heroSub: { fontSize: 13, color: '#C0DD97', lineHeight: 1.6, marginBottom: '1.25rem', maxWidth: 500 },
  searchWrap: {
