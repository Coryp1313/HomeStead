...
const s = {
  page: { fontFamily: 'system-ui, -apple-system, sans-serif', background: '#f5f5f0', minHeight: '100vh' },

  nav: { background: '#fff', borderBottom: '0.5px solid rgba(0,0,0,0.08)', padding: '0 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 58, position: 'sticky', top: 0, zIndex: 100 },
  ...
  brand: { fontSize: 17, fontWeight: 500, color: '#0f0f0e' },
  navRight: { display: 'flex', alignItems: 'center', gap: 10 },
  navLink: { padding: '7px 14px', background: 'transparent', border: 'none', fontSize: 14, cursor: 'pointer', color: '#555', fontFamily: 'inherit' },
  navCta:  { padding: '7px 16px', background: '#3B6D11', color: '#EAF3DE', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' },

  hero: { background: 'linear-gradient(160deg, #173404 0%, #27500A 60%, #3B6D11 100%)', padding: '5rem 1.5rem 4rem' },
  heroInner: { maxWidth: 600, margin: '0 auto', textAlign: 'center' },
  heroPill: { display: 'inline-block', background: 'rgba(151,196,89,0.2)', color: '#C0DD97', fontSize: 12, fontWeight: 500, letterSpacing: 0.6, padding: '5px 14px', borderRadius: 999, border: '0.5px solid rgba(151,196,89,0.3)', marginBottom: 20 },
  heroH: { fontSize: 42, fontWeight: 500, color: '#f2f7eb', lineHeight: 1.18, letterSpacing: -0.5, marginBottom: 16 },
  heroSub: { fontSize: 16, color: '#C0DD97', lineHeight: 1.65, marginBottom: 32, maxWidth: 480, margin: '0 auto 32px' },
  heroBtns: { display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 28 },
  heroCtaPrimary:   { padding: '13px 28px', background: '#EAF3DE', color: '#27500A', border: 'none', borderRadius: 10, fontSize: 15, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' },
  heroCtaSecondary: { padding: '13px 24px', background: 'transparent', color: '#C0DD97', border: '0.5px solid rgba(192,221,151,0.4)', borderRadius: 10, fontSize: 15, cursor: 'pointer', fontFamily: 'inherit' },
  heroTrust: { display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' },
  trustPill: { fontSize: 12, color: '#97C459', background: 'rgba(151,196,89,0.12)', padding: '4px 12px', borderRadius: 999, border: '0.5px solid rgba(151,196,89,0.2)' },

  features: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12, padding: '3rem 1.5rem', maxWidth: 900, margin: '0 auto' },
  featCard: { background: '#fff', border: '0.5px solid rgba(0,0,0,0.08)', borderRadius: 14, padding: '1.25rem' },
  featIcon: { fontSize: 28, marginBottom: 10 },
  featTitle:{ fontSize: 14, fontWeight: 500, marginBottom: 5 },
  featDesc: { fontSize: 13, color: '#666', lineHeight: 1.55 },

  proofSection: { padding: '2rem 1.5rem 3rem', maxWidth: 900, margin: '0 auto' },
  proofTitle: { fontSize: 18, fontWeight: 500, textAlign: 'center', marginBottom: 20 },
  quotes: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 },
  quoteCard: { background: '#fff', border: '0.5px solid rgba(0,0,0,0.08)', borderRadius: 14, padding: '1.25rem' },
  quoteText: { fontSize: 13, color: '#444', lineHeight: 1.65, marginBottom: 12, fontStyle: 'italic' },
  quoteName: { fontSize: 13, fontWeight: 500 },
  quoteFarm: { fontSize: 12, color: '#888' },

  bottomCta: { background: '#27500A', padding: '3.5rem 1.5rem', textAlign: 'center' },
  bottomH:   { fontSize: 26, fontWeight: 500, color: '#f2f7eb', marginBottom: 8 },
  bottomSub: { fontSize: 14, color: '#C0DD97', marginBottom: 24 },

  // Modal
  modalBg: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '1rem' },
  modalCard: { background: '#fff', borderRadius: 18, padding: '2rem', maxWidth: 420, width: '100%', maxHeight: '90vh', overflowY: 'auto' },
  modalHeader: { textAlign: 'center', marginBottom: 24 },
  modalLogo: { fontSize: 36, marginBottom: 12 },
  modalTitle: { fontSize: 20, fontWeight: 500, marginBottom: 6, color: '#0f0f0e' },
  modalSub:   { fontSize: 13, color: '#888', lineHeight: 1.5 },
  formGroup:  { marginBottom: 14 },
  label:  { display: 'block', fontSize: 12, color: '#555', marginBottom: 6 },
  input:  { width: '100%', padding: '11px 13px', borderRadius: 9, border: '0.5px solid rgba(0,0,0,0.2)', fontSize: 14, outline: 'none', boxSizing: 'border-box', fontFamily: 'inherit' },
  errorBox: { background: '#FCEBEB', color: '#A32D2D', borderRadius: 8, padding: '9px 13px', fontSize: 13, marginBottom: 12 },
  authBtn: { width: '100%', padding: '13px', background: '#3B6D11', color: '#EAF3DE', border: 'none', borderRadius: 10, fontSize: 15, fontWeight: 500, cursor: 'pointer', marginTop: 4, fontFamily: 'inherit' },
  divider: { textAlign: 'center', margin: '16px 0', fontSize: 12, color: '#bbb', position: 'relative' },
  guestBtn: { width: '100%', padding: '11px', background: 'transparent', border: '0.5px solid rgba(0,0,0,0.15)', borderRadius: 10, fontSize: 14, cursor: 'pointer', color: '#555', fontFamily: 'inherit' },
  switchAuth: { textAlign: 'center', marginTop: 16, fontSize: 13, color: '#888' },
